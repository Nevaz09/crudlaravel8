...
<html lang="en">
  ...
  <body>
    <h3 class="text-center mt-5 mb-3">Edit Data Pegawai</h3>
                  ...
                  <div class="card-body">
                      <form action="/updatepegawai/{{$data->id}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="number" name="no_telp" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{$data->no_telp}}">
                        </div>
